...
# Veri henüz yoksa üret (api klasöründeki ortak DB'yi kullanır)
python generate_synthetic_data.py

# Jupyter notebook ile interaktif gez
jupyter notebook demo.ipynb

# Veya komut satırından tek tek modüller
...
Yaklaşan giderler (maaş, kira, vergi) takvimi entegre.
...
DB yoksa `python generate_synthetic_data.py` üretir.


## Bir not

Bu klasördeki notebook'u açıp gezdirmek, ne yaptığımı anlamak için en hızlı
yol. Her hücre yorumla başlıyor, çıktısı görselle bitiyor.
